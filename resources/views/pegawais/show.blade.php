...
@section('contents')
    ...
    <div class="row">
        ...
        <div class="col mb-3">
            ...
            <input type="text" name="gaji" class="form-control" placeholder="Gaji" value="{{ $pegawai->gaji }}" readonly>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
            <label class="form-label">Jabatan</label>
            <input type="text" name="jabatan" class="form-control" placeholder="Pegawai Code" value="{{ $pegawai->jabatan }}" readonly>
        </div>
        <div class="col mb-3">
            <label class="form-label">Alamat</label>
            <textarea class="form-control" name="alamat" placeholder="alamat" readonly>{{ $pegawai->alamat }}</textarea>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
